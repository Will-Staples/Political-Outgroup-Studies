...
```{r, }
# NOTE FOR THE READER: This doc differs from the others because it contains the conservative supplement dataset. It does not contain polornt Xtrm or ig.og analyses, the code for those can be found in Jason_Doc.
```
...
dat5 <- read_csv("C:/Users/bacon/OneDrive/Desktop/PhD/Studies/Political outgtoup study/Conservative_Supp/Con_Sup_dat1.csv",
    col_types = cols(age = col_number(), 
        gndr = col_character(), 
        race = col_character(),
        relstat = col_character(),
...
```{r, recode dat5, echo=FALSE, include=FALSE, warning=FALSE}
#work
dat5$work <- recode(dat5$work, "Unemployed (Currently looking)" = "Ucl", "Student" = "Stu", "Full-time" = "FT", "Part-time" = "PT", "Self-employed" = "SE", "Stay at home parent" = "SaHP", "Unemployed (not currently looking)" = "Ucl", "Retired" = "RT", "Unable to work" = "UtW")

#race
dat5$race <- recode(dat5$race, "White" = "W", "Asian/Pacific Islander" = "API", "Hispanic or Latino/Latina/Latinx" = "H/L", "Black" = "B", "Indigenous" = "I", "Other" = "O", "Biracial/Mixed" = "Bi")

#edu
dat5$edu <- recode(dat5$edu, "Less than a high school diploma" = "<HS", "College Diploma" = "Col", "High school diploma or equivalent" = "HS", "Bachelor’s degree" = "BA", "Master’s degree" = "MA", "Doctorate" = "PhD", "Associate's Degree" = "AD", "Other (please specify)" = "O")

#relstat
dat5$relstat <- recode(dat5$relstat, "Single (never married)" = "Snm", "In a domestic partnership (dating, etc.)" = "Dat", "Married" = "M", "Divorced" = "Div", "Widowed" = "W")

#gndr
dat5$gndr <- recode(dat5$gndr, "Man" = "M", "Woman" = "W", "Prefer not to say" = "PnS", "Other" = "O", "Non-Binary or Genderqueer" = "NB", "Trans Woman" = "W")

#Tweets
dat5$tweets <- recode(dat5$tweets, "TweetsL" = "L", "TweetsR" = "R")


#### ABPC ####
dat5$abpc.9 <- recode(dat5$abpc.9, "Strongly agree" = 5,
                     "Somewhat agree" = 4,
                     "Neither agree nor disagree" = 3,
                     "Somewhat disagree" = 2,
                     "Strongly disagree" = 1)
dat5$abpc.12 <- recode(dat5$abpc.12, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.13 <- recode(dat5$abpc.13, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.14 <- recode(dat5$abpc.14, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.15 <- recode(dat5$abpc.15, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.16 <- recode(dat5$abpc.16, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.17 <- recode(dat5$abpc.17, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.21 <- recode(dat5$abpc.21, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.22 <- recode(dat5$abpc.22, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.23 <- recode(dat5$abpc.23, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.25 <- recode(dat5$abpc.25, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.26 <- recode(dat5$abpc.26, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.27 <- recode(dat5$abpc.27, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.28 <- recode(dat5$abpc.28, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.29 <- recode(dat5$abpc.29, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.31 <- recode(dat5$abpc.31, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.32 <- recode(dat5$abpc.32, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
dat5$abpc.33 <- recode(dat5$abpc.33, "Strongly agree" = 5,
                      "Somewhat agree" = 4,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 2,
                      "Strongly disagree" = 1)
# Reverse coded ABPC items: 
dat5$abpc.1 <- recode(dat5$abpc.1, "Strongly agree" = 1,
                     "Somewhat agree" = 2,
                     "Neither agree nor disagree" = 3,
                     "Somewhat disagree" = 4,
                     "Strongly disagree" = 5)
dat5$abpc.2 <- recode(dat5$abpc.2, "Strongly agree" = 1,
                     "Somewhat agree" = 2,
                     "Neither agree nor disagree" = 3,
                     "Somewhat disagree" = 4,
                     "Strongly disagree" = 5)
dat5$abpc.3 <- recode(dat5$abpc.3, "Strongly agree" = 1,
                     "Somewhat agree" = 2,
                     "Neither agree nor disagree" = 3,
                     "Somewhat disagree" = 4,
                     "Strongly disagree" = 5)
dat5$abpc.4 <- recode(dat5$abpc.4, "Strongly agree" = 1,
                     "Somewhat agree" = 2,
                     "Neither agree nor disagree" = 3,
                     "Somewhat disagree" = 4,
                     "Strongly disagree" = 5)
dat5$abpc.5 <- recode(dat5$abpc.5,"Strongly agree" = 1,
                     "Somewhat agree" = 2,
                     "Neither agree nor disagree" = 3,
                     "Somewhat disagree" = 4,
                     "Strongly disagree" = 5)
dat5$abpc.6 <- recode(dat5$abpc.6, "Strongly agree" = 1,
                     "Somewhat agree" = 2,
                     "Neither agree nor disagree" = 3,
                     "Somewhat disagree" = 4,
                     "Strongly disagree" = 5)
dat5$abpc.7 <- recode(dat5$abpc.7, "Strongly agree" = 1,
                     "Somewhat agree" = 2,
                     "Neither agree nor disagree" = 3,
                     "Somewhat disagree" = 4,
                     "Strongly disagree" = 5)
dat5$abpc.8 <- recode(dat5$abpc.8, "Strongly agree" = 1,
                     "Somewhat agree" = 2,
                     "Neither agree nor disagree" = 3,
                     "Somewhat disagree" = 4,
                     "Strongly disagree" = 5)
dat5$abpc.10 <- recode(dat5$abpc.10, "Strongly agree" = 1,
                      "Somewhat agree" = 2,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 4,
                      "Strongly disagree" = 5)
dat5$abpc.11 <- recode(dat5$abpc.11, "Strongly agree" = 1,
                      "Somewhat agree" = 2,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 4,
                      "Strongly disagree" = 5)
dat5$abpc.13 <- recode(dat5$abpc.13, "Strongly agree" = 1,
                      "Somewhat agree" = 2,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 4,
                      "Strongly disagree" = 5)
dat5$abpc.18 <- recode(dat5$abpc.18, "Strongly agree" = 1,
                      "Somewhat agree" = 2,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 4,
                      "Strongly disagree" = 5)
dat5$abpc.19 <- recode(dat5$abpc.19, "Strongly agree" = 1,
                      "Somewhat agree" = 2,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 4,
                      "Strongly disagree" = 5)
dat5$abpc.20 <- recode(dat5$abpc.20, "Strongly agree" = 1,
                      "Somewhat agree" = 2,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 4,
                      "Strongly disagree" = 5)
dat5$abpc.24 <- recode(dat5$abpc.24, "Strongly agree" = 1,
                      "Somewhat agree" = 2,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 4,
                      "Strongly disagree" = 5)
dat5$abpc.30 <- recode(dat5$abpc.30, "Strongly agree" = 1,
                      "Somewhat agree" = 2,
                      "Neither agree nor disagree" = 3,
                      "Somewhat disagree" = 4,
                      "Strongly disagree" = 5)
#### 2 Factor MJI ####
dat5$F1.1 <- recode(dat5$F1.1,
                   "Very intentional" = 5,
                   "Mostly intentional" = 4,
                   "Neither Intentional nor unintentional" = 3,
                   "Somewhat intentional" = 2,
...
dat5$F1.2 <- recode(dat5$F1.2, "Entirely on purpose" = 5,
                   "Mostly on purpose" = 4,
                   "Moderately on purpose" = 3,
                   "Somewhat on purpose" = 2,
                   "Not at all on purpose" = 1)
...
```{r, }
# Main Effects
PI.ME <- ggplot(dat, aes(x=PI, y=sqr.mji)) +
          geom_boxplot(position=position_dodge(1)) + theme_classic()  + ggtitle("Main Effect: PI")
PI.ME

ABPC.ME <-  ggplot(data = dat) +
    aes(x = abpc, y = sqr.mji) +
    stat_summary(fun = mean, geom = "point") + 
    geom_smooth(method=lm) + theme_classic() + ggtitle("Main Effect: ABPC")
ABPC.ME

# Interaction Effects
DIxtweet <- ggplot(dat, aes(x=DI, y=sqr.mji, fill=tweets)) +
          geom_boxplot(position=position_dodge(1)) + theme_classic()  + ggtitle("DIxTweets")
DIxtweet
...
PIxTweet <- ggplot(dat, aes(x=PI, y=sqr.mji, fill=tweets)) +
          geom_boxplot(position=position_dodge(1)) + theme_classic() + ggtitle("PIxTweets")
PIxTweet
...
```{r, }
mdl.right.abpcES <- lm(sqr.mji ~ abpc*PI*DI*tweets, data = subset(dat, abpc.es >= med.abpc.es))
